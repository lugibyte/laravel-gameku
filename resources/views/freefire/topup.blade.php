    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <img src="https://fonts.gstatic.com/s/i/materialicons/sports_esports/v5/24px.svg?download=true" width="30" height="30" class="d-inline-block" alt="" style="filter: contrast(4) invert(1);"> <b style=" letter-spacing: 2px; ">TOP UP GAME FREE FIRE</b>
                </div>
                ...
                <form method="POST" action="{{ route('storexxx') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                @foreach ($fftopup as $ff)
                                <option value="{{$ff->denom}}">{{$ff->denom, }} Diamond</option>
                                @endforeach
                                </select>
