    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <img src="https://fonts.gstatic.com/s/i/materialicons/sports_esports/v5/24px.svg?download=true" width="30" height="30" class="d-inline-block" alt="" style="filter: contrast(4) invert(1);"> <b style=" letter-spacing: 2px; ">TOP UP GAME PUBG MOBILE</b>
                </div>
                ...
                <form method="POST" action="{{ route('storexxx') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                @foreach ($pgtopup as $pg)
                                <option value="{{$pg->denom}}">{{$pg->denom, }} UC</option>
                                @endforeach
                                </select>
